...
$template['logo_url'] = $awss3.'/companies/systag/logo';
...
$template['we_are'] = array(
  'A Swiss company operating worldwide as a partner of the pharmaceutical and chemical industry for automation in R&D laboratories.',
  'A Swiss company operating worldwide as a partner of the pharmaceutical and chemical industry for automation in R&D laboratories.');
$template['we_offer'] = array(
  'The flexibility to work from home and be involved in diverse fields within the company. Our flat hierarchy allows you to develop yourself and make a difference through your own initiative.',
  'The flexibility to work from home and be involved in diverse fields within the company. Our flat hierarchy allows you to develop yourself and make a difference through your own initiative.');
$template['we_look'] = array(
  'People who do not want to be just an anonymous number in a big company. For our positions in product development (software and hardware), project management and engineering we prefere people with a background in science or engineering.',
  'People who do not want to be just an anonymous number in a big company. For our positions in product development (software and hardware), project management and engineering we prefere people with a background in science or engineering.');
