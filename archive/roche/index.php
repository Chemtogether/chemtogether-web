...
$template['company_name'] = 'Roche';
$template['company_name_short'] = 'roche';
$template['logo_url'] = $awss3_archive.'/roche/logo';
...
$template['homepage'] = array('https://www.roche.com','roche.com');
$template['facebook'] = array('https://www.facebook.com/RocheCareers', 'Roche');
$template['linkedin'] = array('https://www.linkedin.com/company/roche/','Roche');
// $template['mail'] = array('','');
...
medicines in oncology, immunology,
infectious diseases, ophthalmology
and neuroscience. Roche is also the
world leader in in vitro diagnostics and
tissue-based cancer diagnostics, and
a frontrunner in diabetes management.
Roche’s personalised healthcare
strategy aims at providing medicines
and diagnostics that enable tangible
improvements in the health, quality
of life and survival of patients. In 2013
the Roche Group invested around 8.7
billion Swiss francs in R&D and posted
sales of 46.8 billion Swiss francs.<br>
...
$template['we_offer'] = array(
  'As an intern or postdoc at Roche, you
can participate in the important work
that is helping to change patients’ lives
all over the world. For enrolled Bachelor
and Master students we offer the
opportunity to gain insights into the
following specialist areas over a threeto
twelve-month period: Research,
Development, Production, Business
functions. Roche also offers a Postdoc
Fellowship Programme for students
who finished their PhD. By working
in international and cross-functional
teams, you will be quickly integrated
into the diverse and multifaceted
Roche world, allowing you to gain
insight and experience from working
alongside exceptional scientists and researchers.
Also, by actively participating
in projects, you will be challenged
to give your best every day and take on
...
$template['we_look'] = array(
  'Candidates who are currently enrolled
in a Bachelor, Master or PhD program
with good grades and have some practical
experience, a very good command
of English, strong teamwork and communication
skills paired with personal
dedication.',
  'Candidates who are currently enrolled
in a Bachelor, Master or PhD program
with good grades and have some practical
