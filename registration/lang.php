...
$lang['content']['form_package_option2'] = array("Ag (nur dienstags verfügbar)", "Ag (only available on Tuesdays)");
$lang['content']['form_package_option3'] = array("Au (nur mittwochs verfügbar)", "Au (only available on Wednesdays)");
