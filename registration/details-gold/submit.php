...
if (!isset($_POST["token"]) || ($_POST["token"] != getenv("DETAILS_GOLD_TOKEN"))){
...
$create_query = "CREATE TABLE IF NOT EXISTS detailsgold (id INTEGER PRIMARY KEY, mail TEXT, company TEXT, representatives TEXT, cars TEXT, languages TEXT, employee TEXT, qualification TEXT, options TEXT, foundingyear TEXT, sites TEXT, additionalfacts TEXT, weare TEXT, weoffer TEXT, welooking TEXT, additionalinfo TEXT, comment TEXT ,y TEXT, flashpresentation TEXT, successfulupload BOOLEAN)";
