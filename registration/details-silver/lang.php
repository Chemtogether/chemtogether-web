...
$lang['general']['page_title'] = array('Chemtogether 2024 - Details Silber', 'Chemtogether 2024 - Details Silver');
...
$lang['content']['booth_spacer'] = array("<b> Standposition </b> Bitte geben Sie 3 Präferenzen für die Positionierung Ihres Firmenstandes nach dem untenstehenden Schlüssel an, wobei die höchste Präferenz Vorrang hat. Wir werden versuchen, alle Wünsche zu berücksichtigen und werden nach dem Prinzip 'wer zuerst kommt, mahlt zuerst' vorgehen, falls kein Konsens gefunden werden kann.", "<b> Booth position </b> Please specify 3 preferences for the positioning of your company booth according to the key shown below, with the highest-priority preference first. We will attempt to take all wishes into account and will use the 'first come first served' principle in the case that no consensus can be found.");
