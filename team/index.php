  ...
  <div class="container">
    ...
    <div class="content flex">
      <div class="image-big l-12 m-12 s-12">
        <div>
          <img <?php set_source($awss3.'/img/team/2025/team_full','jpg'); ?>></img>
        </div>
      </div>
    </div>
    ...
    <?php for ($member_id=1; $member_id <= sizeof($lang['team']); $member_id++) { ?>
      ...
      <div class="content flex-center">
        <div class="image-member l-4 m-6 s-12">
          <div>
          <img <?php set_source($awss3.'/img/team/2025/member_'.$member_id,'jpg'); ?>></img>
          </div>
        </div>
    ...
    <div class="text l-6 m-12 s-12">
        ...
        <?php echo($lang['content']['alumni_member_2021']); ?>
      </div>
    ...
    <div class="text l-6 m-12 s-12">
        ...
        <?php echo($lang['content']['alumni_member_2020']); ?>
      </div>
    ...
    <div class="content flex-center">
      <div class="image-organisation l-4 m-6 s-12">
      <div>
          <img <?php set_source($awss3.'/img/organisation/psa','png'); ?>></img>
        </div>
      </div>
      <div class="text l-8 m-6 s-12">
        <div class="subsection">
          <?php echo($lang['content']['organisation']['psa'][$eng]); ?>
        </div>
        <a href="https://www.psa2.ethz.ch/">www.psa.ethz.ch</a>
      </div>
    </div>
    ...
    <div class="content flex-center">
      ...
      <div class="text l-8 m-6 s-12">
        ...
        <a href="http://www.vecs.ch/01_aktuell.htm">www.vecs.ch</a>
      </div>
    </div>
