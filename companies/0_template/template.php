        ...
        <div class="text l-8 m-8 s-12">
          <div class="successstory-info">
            <span><?php echo($template['successstory'][$i]['name']); ?></span><br>
              <span><?php echo($lang['detail']['successstorys']['introduction'][$eng]); ?></span>
            </div>
          </div>
        </div>

            <div class="content flex" id="successstory-<?php echo($i); ?>">
            ...
            <div class="content flex">
              <div class="text l-12 m-12 s-12">
                <div class="successstory-separator spoiler-button" data-targetid="successstory-<?php echo($i); ?>">
                  <span><i class="rotate fas fa-chevron-down"></i></span>
                  <span><?php echo($lang['detail']['successstorys']['read_more'][$eng]); ?></span>
                </div>
              </div>
            </div>
