...
$data['day1'][$i++] = array(
    ...
    "logo_url" => set_source($awss3.'/companies/lonza/logo','png', FALSE),
    "name" => "<br>  Lonza <br>  <br> ",
    "name_short" => "Lonza",
    "package" => 'gold',
);
...
$data['day1'][$i++] = array(
    ...
    "logo_url" => set_source($awss3.'/companies/buchi/logo','png', FALSE),
    "name" => "<br> BÜCHI Labortechnik AG <br>  <br> ",
    "name_short" => "buchi",
    "package" => 'base',
);
