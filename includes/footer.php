  ...
  <div id="footer" class="flex">
    ...
    <div class="footer-left l-5 m-12 s-12">
      <span id="footer-text">
        ...
        <p class="footer-text-4"><?php echo($lang['footer']['organisation1'][$eng]); ?> <a href="http://vcs.ethz.ch">VCS</a>, <a href="http://vac.ethz.ch">VAC</a>, <a href="https://www.apv.ethz.ch/">APV</a> &amp; <a href="https://psa2.ethz.ch/">PSA</a><br><?php echo($lang['footer']['organisation2'][$eng]); ?> <a href="http://vseth.ethz.ch">VSETH</a> &amp; <a href="http://aveth.ethz.ch">AVETH</a></p>
      </span>
    </div>
    ...
    <div class="footer-right l-7 m-12 s-12">
       <div class="date-container">
        <span id="date-day1">12.</span>
        <span class="date-bar"></span>
        <span id="date-day2">13.</span>
      </div> 
      <div class="date-container">
